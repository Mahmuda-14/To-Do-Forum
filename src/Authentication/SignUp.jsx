...
const SignUp = () => {
    ...
    return (
        <>
            ...
            <div className=" hero mt-[26px] mb-16">



                <div className="w-[24rem] h-[41rem] my-11 border-4 border-y-red-900 shadow-2xl bg-base-100">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                        ...
                        <div className="form-control">
                            <input className="btn bg-red-900 text-white" type="submit" value="Sign Up" />
                        </div>
                    </form>
